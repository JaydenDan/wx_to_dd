...
VXHOOK_CALLBACK_HOST = os.getenv("VXHOOK_CALLBACK_HOST", "127.0.0.1")
VXHOOK_CALLBACK_PORT = int(os.getenv("VXHOOK_CALLBACK_PORT", "5000"))
VXHOOK_CALLBACK_PATH = os.getenv("VXHOOK_CALLBACK_PATH", "/api/recvMsg")
